...
out = r"G:\GiantsRE\reports\frida_ddraw_recomp.txt"
pid = frida.spawn(["GiantsMain_vanilla.exe", ""])
s = frida.attach(pid)
script = s.create_script(open(r"G:\GiantsRE\scripts\frida_ddraw_recomp.js").read())
lines=[]
def on_msg(msg,data):
